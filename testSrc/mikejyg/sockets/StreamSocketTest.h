...
#ifndef TESTSRC_MIKEJYG_STREAMSOCKETTEST_H_
#define TESTSRC_MIKEJYG_STREAMSOCKETTEST_H_

#include <mikejyg/sockets/StreamSocket.h>
...
public:
	 ...
	 */
	static void testClient(std::string const & hostname, unsigned port) {
...
#endif /* TESTSRC_MIKEJYG_STREAMSOCKETTEST_H_ */
